...
def fieldorder(graph: Stream, order: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="fieldorder", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="order", value=order)])
    )
    return new_graph
...
def maskedmerge(graph: Stream, planes: Optional[int] = None):
    ...
    :param int planes: set planes"""
    new_graph = graph.append(
        Filter(command="maskedmerge", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="planes", value=planes)])
    )
    return new_graph
...
def threshold(graph: Stream, planes: Optional[int] = None):
    ...
    :param int planes: set planes to filter"""
    new_graph = graph.append(
        Filter(command="threshold", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="planes", value=planes)])
    )
    return new_graph
...
def midequalizer(graph: Stream, planes: Optional[int] = None):
    ...
    :param int planes: set planes"""
    new_graph = graph.append(
        Filter(command="midequalizer", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="planes", value=planes)])
    )
    return new_graph
...
def shuffleframes(graph: Stream, mapping: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="shuffleframes", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="mapping", value=mapping)])
    )
    return new_graph
...
def weave(graph: Stream, first_field: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="weave", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="first_field", value=first_field)])
    )
    return new_graph
...
def ssim(graph: Stream, stats_file: Optional[str] = None):
    ...
    :param str stats_file: Set file where to store per-frame difference information"""
    new_graph = graph.append(
        Filter(command="ssim", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="stats_file", value=stats_file)])
    )
    return new_graph
...
def vmafmotion(graph: Stream, stats_file: Optional[str] = None):
    ...
    :param str stats_file: Set file where to store per-frame difference information"""
    new_graph = graph.append(
        Filter(command="vmafmotion", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="stats_file", value=stats_file)])
    )
    return new_graph
...
def asetrate(graph: Stream, sample_rate: Optional[int] = None):
    ...
    new_graph = graph.append(
        Filter(command="asetrate", filter_type="AVMEDIA_TYPE_AUDIO", params=[FilterOption(name="sample_rate", value=sample_rate)])
    )
    return new_graph
...
def acontrast(graph: Stream, contrast: Optional[float] = None):
    ...
    new_graph = graph.append(
        Filter(command="acontrast", filter_type="AVMEDIA_TYPE_AUDIO", params=[FilterOption(name="contrast", value=contrast)])
    )
    return new_graph
...
def siti(graph: Stream, print_summary: Optional[bool] = None):
    ...
    new_graph = graph.append(
        Filter(command="siti", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="print_summary", value=print_summary)])
    )
    return new_graph
...
def drmeter(graph: Stream, length: Optional[float] = None):
    ...
    :param float length: set the window length"""
    new_graph = graph.append(
        Filter(command="drmeter", filter_type="AVMEDIA_TYPE_AUDIO", params=[FilterOption(name="length", value=length)])
    )
    return new_graph
...
def removelogo(graph: Stream, filename: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="removelogo", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="filename", value=filename)])
    )
    return new_graph
...
def framepack(graph: Stream, format: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="framepack", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="format", value=format)])
    )
    return new_graph
...
def pp(graph: Stream, subfilters: Optional[str] = None):
    ...
    new_graph = graph.append(
        Filter(command="pp", filter_type="AVMEDIA_TYPE_VIDEO", params=[FilterOption(name="subfilters", value=subfilters)])
    )
    return new_graph
